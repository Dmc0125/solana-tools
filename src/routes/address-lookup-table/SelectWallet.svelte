...
{#key show}
	<dialog
		open={show}
		class="fixed top-[-200px] left-0 h-[calc(100vh+200px)] w-full bg-white/5 p-0 z-50"
		on:click={() => (show = false)}
	...
	>
		<div class="absolute bottom-0 w-full rounded-t-lg bg-gray-800 p-5" on:click|stopPropagation>
